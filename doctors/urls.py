...
from .views import DoctorViewSet, BestDoctorViewSet, DepartmentViewSet, ServiceViewSet, ChamberTimeViewSet, DepartmentGroupListAPIView, DepartmentGroupRetrieveUpdateAPIView
